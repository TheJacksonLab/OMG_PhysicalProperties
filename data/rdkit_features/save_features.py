...
sys.path.append('/home/sk77/PycharmProjects/omg_database_publication/external_packages/chemprop')
sys.path.append('/home/sk77/PycharmProjects/omg_database_publication/external_packages/descriptastorus')
...
if __name__ == '__main__':
    # General arguments
    features_arguments = [
        '--data_path', f'/home/sk77/PycharmProjects/omg_database_publication/scaffold_data/OMG_methyl_terminated_polymers.csv',
        # '--data_path', '/home/sk77/PycharmProjects/omg_database_publication/scaffold_data/OMG_scaffold_train_batch_0.csv',  # test
        '--smiles_column', 'methyl_terminated_product',
        '--features_generator', 'rdkit_2d_normalized',
        '--save_path', f'./rdkit_features',
    ]
    generate_and_save_features(Args().parse_args(features_arguments))
